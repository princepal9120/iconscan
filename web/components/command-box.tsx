...
export function CommandBox({
  ...
  const [active, setActive] = useState<string>(Object.keys(commands)[0]);
  ...
  return (
    <div className="w-full max-w-md overflow-hidden rounded-lg border border-border bg-card text-left">
